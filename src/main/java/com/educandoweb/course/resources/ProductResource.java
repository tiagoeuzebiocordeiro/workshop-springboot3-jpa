...
@RequestMapping(value = "/products") /*Isso dá um nome pro recurso, de valor(caminho), recurso para entidade users, então vai chamar users*/
public class ProductResource {			/*Essa classe disponibiliza um recurso web disponível para a entidade Product*/
	...
	@GetMapping
	public ResponseEntity<List<Product>> findAll() { /*Método que responde as requisições WEB GET (endpoint para acessar users)*/
